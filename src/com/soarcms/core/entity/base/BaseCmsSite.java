...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.soarcms.core.entity.CmsConfig config,
	...
	// many to one
	private com.soarcms.core.entity.Ftp uploadFtp;
	private com.soarcms.core.entity.CmsConfig config;
	// one to one
	private com.soarcms.core.entity.CmsSiteCompany siteCompany;
	 ...
	 */
	public com.soarcms.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.soarcms.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.soarcms.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.soarcms.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.soarcms.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.soarcms.core.entity.CmsSiteCompany siteCompany) {
	...
	public void setUserSites(
			java.util.Set<com.soarcms.core.entity.CmsUserSite> userSites) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.soarcms.core.entity.CmsSite)) return false;
		else {
			com.soarcms.core.entity.CmsSite cmsSite = (com.soarcms.core.entity.CmsSite) obj;
