...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.soarcms.core.entity.MarkConfig m_markConfig;
	 com.soarcms.core.entity.EmailConfig m_emailConfig;
	...
	public com.soarcms.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.soarcms.core.entity.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}


	public com.soarcms.core.entity.EmailConfig getEmailConfig () {
	 ...
	 */
	public void setEmailConfig (com.soarcms.core.entity.EmailConfig m_emailConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.soarcms.core.entity.CmsConfig)) return false;
		else {
			com.soarcms.core.entity.CmsConfig cmsConfig = (com.soarcms.core.entity.CmsConfig) obj;
