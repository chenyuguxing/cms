package com.soarcms.cms.entity.assist.base;
...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.soarcms.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.soarcms.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.soarcms.core.entity.CmsUser member;
	private com.soarcms.core.entity.CmsUser admin;
	private com.soarcms.core.entity.CmsSite site;
	private com.soarcms.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.soarcms.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.soarcms.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.soarcms.core.entity.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.soarcms.core.entity.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.soarcms.core.entity.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.soarcms.core.entity.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.soarcms.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.soarcms.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.soarcms.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.soarcms.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.soarcms.cms.entity.assist.CmsGuestbook) obj;
