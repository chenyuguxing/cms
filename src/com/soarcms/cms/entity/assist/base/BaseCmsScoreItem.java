...
public abstract class BaseCmsScoreItem  implements Serializable {
	...
	// many to one
	private com.soarcms.cms.entity.assist.CmsScoreGroup group;

	// collections
	private java.util.Set<com.soarcms.cms.entity.assist.CmsScoreRecord> records;
	 ...
	 */
	public com.soarcms.cms.entity.assist.CmsScoreGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.soarcms.cms.entity.assist.CmsScoreGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.soarcms.cms.entity.assist.CmsScoreRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.soarcms.cms.entity.assist.CmsScoreRecord> records) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.soarcms.cms.entity.assist.CmsScoreItem)) return false;
		else {
			com.soarcms.cms.entity.assist.CmsScoreItem cmsScoreItem = (com.soarcms.cms.entity.assist.CmsScoreItem) obj;
