...
public abstract class BaseCmsSiteFlow  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.soarcms.cms.entity.assist.CmsSiteFlow)) return false;
		else {
			com.soarcms.cms.entity.assist.CmsSiteFlow cmsSiteFlow = (com.soarcms.cms.entity.assist.CmsSiteFlow) obj;
