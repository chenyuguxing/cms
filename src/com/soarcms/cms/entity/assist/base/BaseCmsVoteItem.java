...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	public BaseCmsVoteItem (
		...
		com.soarcms.cms.entity.assist.CmsVoteTopic topic,
	...
	// many to one
	private com.soarcms.cms.entity.assist.CmsVoteTopic topic;
	private com.soarcms.cms.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public com.soarcms.cms.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.soarcms.cms.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public com.soarcms.cms.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(com.soarcms.cms.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.soarcms.cms.entity.assist.CmsVoteItem)) return false;
		else {
			com.soarcms.cms.entity.assist.CmsVoteItem cmsVoteItem = (com.soarcms.cms.entity.assist.CmsVoteItem) obj;
