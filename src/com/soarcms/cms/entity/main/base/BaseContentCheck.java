...
public abstract class BaseContentCheck  implements Serializable {
	...
	private com.soarcms.core.entity.CmsUser reviewer;
	...
	public com.soarcms.core.entity.CmsUser getReviewer() {
		return reviewer;
	}

	public void setReviewer(com.soarcms.core.entity.CmsUser reviewer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.soarcms.cms.entity.main.ContentCheck)) return false;
		else {
			com.soarcms.cms.entity.main.ContentCheck contentCheck = (com.soarcms.cms.entity.main.ContentCheck) obj;
