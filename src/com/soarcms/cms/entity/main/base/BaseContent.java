package com.soarcms.cms.entity.main.base;
...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private com.soarcms.cms.entity.main.ContentExt contentExt;
	private com.soarcms.cms.entity.main.ContentCount contentCount;

	// many to one
	private com.soarcms.cms.entity.main.ContentType type;
	private com.soarcms.core.entity.CmsSite site;
	private com.soarcms.core.entity.CmsUser user;
	private com.soarcms.cms.entity.main.Channel channel;
	private com.soarcms.cms.entity.main.CmsModel model;

	// collections
	private java.util.Set<com.soarcms.cms.entity.main.Channel> channels;
	private java.util.Set<com.soarcms.cms.entity.main.CmsTopic> topics;
	private java.util.Set<com.soarcms.core.entity.CmsGroup> viewGroups;
	private java.util.List<com.soarcms.cms.entity.main.ContentTag> tags;
	private java.util.List<com.soarcms.cms.entity.main.ContentPicture> pictures;
	private java.util.List<com.soarcms.cms.entity.main.ContentAttachment> attachments;
	private java.util.Set<com.soarcms.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.soarcms.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.soarcms.core.entity.CmsUser> collectUsers;
	private java.util.Set<com.soarcms.cms.entity.assist.CmsComment> comments;
	private java.util.Set<com.soarcms.cms.entity.assist.CmsFile> files;
	private java.util.Set<com.soarcms.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.soarcms.cms.entity.assist.CmsScoreRecord> scoreRecordSet;
	...
	public java.util.Set<com.soarcms.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.soarcms.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}
	
	public java.util.Set<com.soarcms.cms.entity.assist.CmsJobApply> getJobApplys() {
			return jobApplys;
	}
	
	public void setJobApplys(
				java.util.Set<com.soarcms.cms.entity.assist.CmsJobApply> jobApplys) {
	...
	public java.util.Set<com.soarcms.cms.entity.assist.CmsScoreRecord> getScoreRecordSet() {
		return scoreRecordSet;
	}

	public void setScoreRecordSet(
			java.util.Set<com.soarcms.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
	 ...
	 */
	public com.soarcms.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.soarcms.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.soarcms.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.soarcms.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.soarcms.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.soarcms.cms.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public com.soarcms.core.entity.CmsSite getSite () {
		return site;
	}
	 ...
	 */
	public void setSite (com.soarcms.core.entity.CmsSite site) {
		this.site = site;
	}
	 ...
	 */
	public com.soarcms.core.entity.CmsUser getUser () {
		return user;
	}
	 ...
	 */
	public void setUser (com.soarcms.core.entity.CmsUser user) {
		this.user = user;
	}
	 ...
	 */
	public com.soarcms.cms.entity.main.Channel getChannel () {
		return channel;
	}
	 ...
	 */
	public void setChannel (com.soarcms.cms.entity.main.Channel channel) {
		this.channel = channel;
	}
	
	public com.soarcms.cms.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(com.soarcms.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<com.soarcms.cms.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<com.soarcms.cms.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<com.soarcms.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.soarcms.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<com.soarcms.core.entity.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<com.soarcms.core.entity.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<com.soarcms.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.soarcms.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.soarcms.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.soarcms.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.soarcms.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.soarcms.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.soarcms.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.soarcms.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.soarcms.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.soarcms.cms.entity.main.ContentCheck> contentCheckSet) {
	...
	public java.util.Set<com.soarcms.core.entity.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.soarcms.core.entity.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.soarcms.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.soarcms.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.soarcms.cms.entity.main.Content)) return false;
		else {
			com.soarcms.cms.entity.main.Content content = (com.soarcms.cms.entity.main.Content) obj;
