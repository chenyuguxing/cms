package com.soarcms.cms.entity.main;
...
import com.soarcms.cms.entity.main.base.BaseChannel;
import com.soarcms.cms.staticpage.StaticPageUtils;
import com.soarcms.common.hibernate3.HibernateTree;
import com.soarcms.common.hibernate3.PriorityComparator;
import com.soarcms.common.hibernate3.PriorityInterface;
...
//			return getUrlDynamic(null);
	...
	public Channel(java.lang.Integer id,
			...
			com.soarcms.cms.entity.main.CmsModel model, java.lang.Integer lft,
